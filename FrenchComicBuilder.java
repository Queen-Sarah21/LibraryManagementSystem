...
public class FrenchComicBuilder implements IComicBuilder {
    Comic comic;
    public FrenchComicBuilder(){this.comic = new Comic();}
    ...
    public void setGenre(){comic.setGenre(Genre.FrenchLiterature);}
    public void setLang(){comic.setLanguage(Language.FR);}
